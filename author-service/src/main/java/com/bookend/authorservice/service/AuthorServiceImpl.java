...
import com.bookend.authorservice.exception.NullAuthorException;
...
public class AuthorServiceImpl implements AuthorService {
    ...
    @Override
    public Author save(AuthorRequest request) throws AuthorAlreadyExists, MandatoryFieldException,NullAuthorException {
        ...
        Author author = new Author(request.getName(),request.getBiography(),LocalDate.parse(request.getBirthDate()),null);
        if(request.getDateOfDeath() != null && request.getDateOfDeath()!=""){
